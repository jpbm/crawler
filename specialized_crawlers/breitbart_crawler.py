...
def get_urls(html):
    """taylored to breitbart"""
    hrefs = [item['href'] for item in BeautifulSoup(html,'html.parser').findAll('a',href=True)]
    full_hrefs = [href for href in hrefs if '.com' in href and 'bart' in href]
    partial_hrefs = ['www.breitbart.com' + href for href in hrefs if len(href)>=2 and href[0] == '/' and href[1] != '/']
...
if __name__ == "__main__":
    ...
    FILENAME = '/datapool/news_articles/raw_data/breitbart/breitbart.json'
    SEED_URL = 'www.breitbart.com'
