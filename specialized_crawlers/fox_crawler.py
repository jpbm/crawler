...
def get_urls(html):
    ...
    full_hrefs = [href for href in hrefs if '.com' in href and 'foxnews' in href]
    partial_hrefs = ['www.foxnews.com' + href for href in hrefs if len(href)>=2 and href[0] == '/' and href[1] != '/']
...
if __name__ == "__main__":
    ...
    FILENAME = '/datapool/news_articles/raw_data/fox/fox.json'
    SEED_URL = 'www.foxnews.com'
